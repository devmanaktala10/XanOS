...
extern int32_t chdir(uint8_t * buf);
extern int32_t mkdir(uint8_t * buf);
extern int32_t rmdir(uint8_t * buf);
extern int32_t create(uint8_t * buf);
extern int32_t unlink(uint8_t * buf);
extern int32_t guireturn(void); 
extern int32_t ioctl(int32_t fd, unsigned long cmd, unsigned long arg);
